/*
  ...
  Circuit:
  * Board with S3 Module (Uno R4 WiFi)
  * LED attached to LED_BUILTIN (or change it to an external LED)

  created 25 Nov 2012
  by Tom Igoe

  Ckleaned up by TomKi:
  * really use int var led to set LED
  * K&R indentation 4 blanks
