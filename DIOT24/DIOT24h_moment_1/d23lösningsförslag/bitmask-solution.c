...
int main(int argc, char **argv) {
    ...
    GPIO_REG = GPIO_REG | GPIO_1;
    GPIO_REG = GPIO_REG & (~GPIO_1_PULLUP);
    /* Utskrift ska bli 00000001 */
    printf("GPIO_REG = %s\n", bin_to_str8(buf, GPIO_REG));
    /* Uppgift 23.2.2:
     *    sätt GPIO_2 PÅ med PULLUP-register PÅ */
    GPIO_REG = GPIO_REG | GPIO_2 | GPIO_2_PULLUP;
    /* Utskrift ska bli 00001101 */
    printf("GPIO_REG = %s\n", bin_to_str8(buf, GPIO_REG));
    /* Uppgift 23.2.3:
     *    sätt GPIO_3 PÅ med PULLUP-register AV och PWM_HI resolution PÅ */
    GPIO_REG = GPIO_REG | GPIO_3 | GPIO_3_PWM_HI;
    GPIO_REG = GPIO_REG & (~GPIO_3_PULLUP);
    ...
    GPIO_REG = GPIO_REG | GPIO_1 | GPIO_2 | GPIO_2_PULLUP | GPIO_3 | GPIO_3_PWM_HI;
    GPIO_REG = GPIO_REG & (~GPIO_1_PULLUP) & (~GPIO_3_PULLUP);
