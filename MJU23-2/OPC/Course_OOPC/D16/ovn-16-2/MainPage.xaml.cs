namespace d16MAUICalculator
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            if (CalcEntry.Text.Length == 0) return;
        ...
        private void OnCaClicked(object sender, EventArgs e)
        {
            CalcEntry.Text = "";
        }
        private void OnBackspaceClicked(object sender, EventArgs e)
        {
            CalcEntry.Text = CalcEntry.Text.Substring(0, CalcEntry.Text.Length - 1);
        }
    }
}
