...
namespace d16bildbladdrare
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            "gora_strimba_vzhimky.jpg", "messier83_heic1403a.jpg",
            "mont_blanc_from_les_arcs_1950a.jpg", "morozhniy_ranok_nad_jaremshsheyo.jpg",
        ...
        {
            InitializeComponent();
            TopImage.Source = imageFilenames[imgNum];
        }
        private void OnPrevClicked(object sender, EventArgs e)
        {
            imgNum--;
            if (imgNum < 0) imgNum = imageFilenames.Length-1;
            TopImage.Source = imageFilenames[imgNum];
        }
        private void OnNextClicked(object sender, EventArgs e)
        {
            imgNum++;
            if (imgNum >= imageFilenames.Length) imgNum = 0;
            TopImage.Source = imageFilenames[imgNum];
        }
        private void CalcEntry_Completed(object sender, EventArgs e)
        {
            double result = ShuntingYard.Execute(CalcEntry.Text);
            string entryString = $"{result}";
            CalcResult.Text = entryString;
        }
    }
}
